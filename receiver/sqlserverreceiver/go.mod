...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/winperfcounters v0.123.0
	...
	go.opentelemetry.io/collector/filter v0.123.1-0.20250402200755-cb5c3f4fb9dc
