...
require (
	...
	github.com/DataDog/datadog-agent/comp/core/config v0.64.2
	github.com/DataDog/datadog-agent/comp/core/hostname/hostnameinterface v0.64.2
	github.com/DataDog/datadog-agent/comp/core/log/def v0.64.2
	github.com/DataDog/datadog-agent/comp/logs/agent/config v0.64.2
	github.com/DataDog/datadog-agent/comp/otelcol/logsagentpipeline v0.64.2
	github.com/DataDog/datadog-agent/comp/otelcol/logsagentpipeline/logsagentpipelineimpl v0.64.2
	...
	github.com/DataDog/datadog-agent/comp/otelcol/otlp/components/metricsclient v0.64.2
	github.com/DataDog/datadog-agent/comp/otelcol/otlp/testutil v0.64.2
	github.com/DataDog/datadog-agent/comp/trace/compression/impl-gzip v0.64.2
	github.com/DataDog/datadog-agent/pkg/config/model v0.64.2
	github.com/DataDog/datadog-agent/pkg/config/setup v0.64.2
	...
	github.com/DataDog/datadog-agent/pkg/logs/sources v0.64.2
...
require (
	...
	github.com/DataDog/datadog-agent/comp/serializer/logscompression v0.64.2
	github.com/DataDog/datadog-agent/pkg/config/viperconfig v0.64.2
