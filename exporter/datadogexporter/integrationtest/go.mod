...
require (
	...
	go.opentelemetry.io/collector/confmap/provider/envprovider v1.29.1-0.20250402200755-cb5c3f4fb9dc
...
require (
	...
	github.com/DataDog/datadog-agent/comp/core/config v0.64.2 // indirect
	github.com/DataDog/datadog-agent/comp/core/flare/builder v0.64.2 // indirect
	github.com/DataDog/datadog-agent/comp/core/flare/types v0.64.2 // indirect
	github.com/DataDog/datadog-agent/comp/core/hostname/hostnameinterface v0.64.2 // indirect
	github.com/DataDog/datadog-agent/comp/core/log/def v0.64.2 // indirect
	...
	github.com/DataDog/datadog-agent/comp/core/telemetry v0.64.2 // indirect
	github.com/DataDog/datadog-agent/comp/def v0.64.2 // indirect
	...
	github.com/DataDog/datadog-agent/comp/logs/agent/config v0.64.2 // indirect
	github.com/DataDog/datadog-agent/comp/otelcol/logsagentpipeline v0.64.2 // indirect
	github.com/DataDog/datadog-agent/comp/otelcol/logsagentpipeline/logsagentpipelineimpl v0.64.2 // indirect
	...
	github.com/DataDog/datadog-agent/comp/otelcol/otlp/components/metricsclient v0.64.2 // indirect
	github.com/DataDog/datadog-agent/comp/otelcol/otlp/components/statsprocessor v0.64.2 // indirect
	github.com/DataDog/datadog-agent/comp/serializer/logscompression v0.64.2 // indirect
	github.com/DataDog/datadog-agent/comp/serializer/metricscompression v0.63.2 // indirect
	github.com/DataDog/datadog-agent/comp/trace/compression/def v0.64.2 // indirect
	github.com/DataDog/datadog-agent/comp/trace/compression/impl-gzip v0.64.2 // indirect
	...
	github.com/DataDog/datadog-agent/pkg/config/utils v0.64.2 // indirect
	...
	github.com/DataDog/datadog-agent/pkg/logs/auditor v0.64.2 // indirect
	github.com/DataDog/datadog-agent/pkg/logs/client v0.64.2 // indirect
	github.com/DataDog/datadog-agent/pkg/logs/diagnostic v0.64.2 // indirect
	github.com/DataDog/datadog-agent/pkg/logs/message v0.64.2 // indirect
	github.com/DataDog/datadog-agent/pkg/logs/metrics v0.64.2 // indirect
	github.com/DataDog/datadog-agent/pkg/logs/pipeline v0.64.2 // indirect
	github.com/DataDog/datadog-agent/pkg/logs/processor v0.64.2 // indirect
	github.com/DataDog/datadog-agent/pkg/logs/sds v0.64.2 // indirect
	github.com/DataDog/datadog-agent/pkg/logs/sender v0.64.2 // indirect
	github.com/DataDog/datadog-agent/pkg/logs/sources v0.64.2 // indirect
	github.com/DataDog/datadog-agent/pkg/logs/status/statusinterface v0.64.2 // indirect
	github.com/DataDog/datadog-agent/pkg/logs/status/utils v0.64.2 // indirect
	...
	github.com/DataDog/datadog-agent/pkg/status/health v0.64.2 // indirect
	...
	github.com/DataDog/datadog-agent/pkg/telemetry v0.64.2 // indirect
	github.com/DataDog/datadog-agent/pkg/trace v0.64.2 // indirect
	github.com/DataDog/datadog-agent/pkg/util/backoff v0.64.2 // indirect
	github.com/DataDog/datadog-agent/pkg/util/buf v0.63.2 // indirect
	github.com/DataDog/datadog-agent/pkg/util/cgroups v0.64.2 // indirect
	github.com/DataDog/datadog-agent/pkg/util/common v0.63.2 // indirect
	github.com/DataDog/datadog-agent/pkg/util/compression v0.64.2 // indirect
	...
	github.com/DataDog/datadog-agent/pkg/util/fxutil v0.64.2 // indirect
	github.com/DataDog/datadog-agent/pkg/util/hostname/validate v0.64.2 // indirect
	github.com/DataDog/datadog-agent/pkg/util/http v0.64.2 // indirect
	...
	github.com/DataDog/datadog-agent/pkg/util/startstop v0.64.2 // indirect
	github.com/DataDog/datadog-agent/pkg/util/statstracker v0.64.2 // indirect
	...
	go.opentelemetry.io/collector/component/componenttest v0.123.1-0.20250402200755-cb5c3f4fb9dc // indirect
